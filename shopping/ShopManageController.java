...
public class ShopManageController {
	...
	@ResponseBody
	public int addProduct(ProductVO bag, HttpServletRequest request, @RequestParam(name = "file1") MultipartFile file) throws Exception {
		...
		if (!file.isEmpty()) {
			...
			bag.setProduct_img(savedName);
		}else {
			bag.setProduct_img("noData");
		}
		System.out.println("컨트롤러12 : " + bag);
